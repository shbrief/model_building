#' This script created MeSH term table used for RAVmodel annotation. The resulting
#' data frame is added in the GenomicSuperSignature package and you can access it 
#' through:
#' 
